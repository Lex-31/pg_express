...
router.get('/api/zp/:id', ProductController.getNotesZp);  // маршрут для полученияd всех записей из одного ЖП по его ID
...
router.put('/api/zp/:noteZp', ProductController.updateNoteZp);  // маршрут для обновления записи в ЖП по ID записи
