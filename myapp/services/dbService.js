    ...
    static async ensureTableExists() {
        ...
        try {
            ...
            CREATE TABLE IF NOT EXISTS ${table_name}_notes_zp (
                ...
                ii_cd VARCHAR(100) DEFAULT '', -- номер извещения об изменении КД
            ...
            if (result2.rowCount === 0) {
                ...
                INSERT INTO ${table_name}_zp (id, zp_name) VALUES
                    ...
                    ('3', 'ПУ.В УП.В'),
                    ('4', 'УПН'),
                    ('5', 'ББП-12 ББП-12/0,5 ББП-12/2'),
                    ('6', 'ПТВЦ'),
                    ('7', 'ББП-12/0,25 ББП-12/0,25'),
                    ('8', 'УРЛ'),
                    ('9', 'ЩВИ'),
                    ('10', 'ППУН'),
                    ('11', 'СЗИЦ'),
                    ('12', 'Громкоговоритель рупорный 10ГР-38СЭ 10ГР-38СЭМ'),
                    ('13', 'ТИС'),
                    ('14', 'ПТ -ЭПТ - 50С'),
                    ('15', 'ФЗ-В'),
                    ('16', 'ППСЦ-В'),
                    ...
                    ('19', 'ППУ-У'),
                    ('20', 'РСДТ-11Ц'),
                    ('21', 'ЗМС-С ЗИС-С ЗМП-С'),
                    ('22', 'ББП 24/1 ББП-24/1'),
                    ('23', 'ВЗУ (РЭ, ПС, этикетка)'),
                    ('24', 'ШВЗУ-01, ШВЗУ ШВЗУ-М'),
                    ('25', 'ВЗУ (ЗИС)'),
                    ('26', 'ВЗУ (ЗМП)'),
                    ('27', 'ВЗУ (ЗМС) Модули защиты ПН-230М, ПН-230- 1М, 1СМ'),
                    ('28', 'ТАН-УГ'),
                    ('29', 'ТАН-У'),
                    ('30', 'ЯАЗ'),
                    ('31', 'Детали общего применения '),
                    ('32', 'Трансформаторы  '),
                    ('33', 'ТПС ТПСЦ'),
                    ('34', 'Реактор разделительный РР Разрядник угольный искровой РУ-И'),
                    ('35', 'ПР.У ПР.У1'),
                    ('36', 'ТА-NT, TA-T ТА-NT ТА-Т'),
                    ('37', 'ТЛТ 200'),
                    ('38', 'Комплекты крепления ОИ-1М'),
                    ('39', 'Педали диспетчера'),
                    ('40', 'КЯ-АЗ'),
                    ('41', 'Стойка-каркас для ввода кабелей'),
                    ('42', 'ПЕРЕГОН - Ц ПЕРЕГОН - ЦМ ПЕРЕГОН-ЦС Держатель трубки телефонной'),
                    ('43', 'ПУ ПУ-П'),
                    ('44', 'ШР-600'),
                    ('45', 'CKПС'),
                    ('46', 'ЩЗ-1'),
                    ('47', 'ПУ.У ПУ.У-П УП.У УП.У-А'),
                    ('48', 'РТА'),
                    ('49', 'Блок защиты БЗ -1'),
                    ('50', 'ШР-300 ШРП-600'),
                    ('51', 'Барьер АБЧК ШАЗ-01 ШАЗ-03'),
                    ('52', 'Барьер АБТ ШАЗ ШАЗ-02'),
                    ('53', 'Блок защиты Блок защиты БЗЛ Блок регистратора Блок защиты БЗК'),
                    ('54', 'БКПТ'),
                    ('55', 'ШРП-300 ШРП-150'),
                    ('56', 'ППСЦ ППСЦ-М ППСЦ-ИВ'),
                    ('57', 'Эксплуатационная документация СДПС-Ц1'),
                    ('58', 'Стойка СКУ МАГО'),
                    ('59', 'Шкаф СДПС-Ц1'),
                    ('60', 'УКФЛ-600'),
                    ('61', 'УУК'),
                    ...
                    ('64', 'КИУ'),
                    ('65', 'УРП'),
                    ('66', 'ВЗУ – СДПС ВЗУ2 ВЗУ1'),
                    ('67', ''),
                    ('68', ''),
                    ('69', ''),
                    ('70', ''),
                    ('71', 'СДПС-Ц2М. Стойка СКУ. М 1 УУК.М1 ВЗУ.М1 БСФ'),
                    ('72', 'АГО АПК'),
                    ('73', 'АПК-1 Устройство клиента Пульт оператора'),
                    ('74', 'СЗИЦ-Д'),
                    ('75', 'УД-3МА'),
                    ('76', 'Комплект кабельных желобов'),
                    ('77', 'ИВГЦ Ручной стенд проверки ИВГЦ'),
                    ('78', 'ШР-50 ШР-150'),
                    ('79', 'СКУ.М1Е'),
                    ('80', 'СДПС-Ц2'),
                    ('81', 'СДПС-Ц2 УТ-200'),
                    ('82', 'УТ200 инд. УТ600 инд. '),
                    ('83', 'ШМБ-М ШМБ-М-У'),
                    ('84', 'Фильтр ЗФ 220-М'),
                    ('85', 'УТ 200Д'),
                    ('86', 'ТРЦ ПП-С ПП-С опытный'),
                    ('87', 'ТРЦ   в  корпусе  ДСШ'),
                    ('88', 'УБКН 1 УБКН 2'),
                    ('89', 'Шкаф для проверки 10ГР-38СЭ Шкаф проверки микрофонов'),
                    ('90', 'УТ600М'),
                    ('91', 'ППУ.ВМ'),
                    ('92', 'УТ200М УТ200М-01'),
                    ('93', 'УТ600Д'),
                    ('94', 'ГП3С-Р ГП-С'),
                    ('95', 'Генератор ТРЦ ГП3С'),
                    ('96', 'ПИ - 8ТП / 485'),
                    ('97', 'ПР. Ц БРК'),
                    ('98', 'СДО'),
                    ('99', 'ИСИ'),
                    ('100', 'ПТДУ-М2'),
                    ('101', 'УЗПС'),
                    ('102', 'Пульт проверки  СДПС-Ц2МД Стенд.МДЕ: Блок нагрузок БПУ600 Стенд проверки БУМ600'),
                    ('103', 'Стенд проверки УТ 200Д'),
                    ('104', 'Стенд автоматической проверки сигнализаторов СЗИЦ-Д и СЗИЦ-Д-Л'),
                    ('105', 'Автоматизированный стенд АСПП ТРЦ АСПП-3'),
                    ('106', '19" шкаф для оборудования навесной'),
                    ('107', 'Шкаф оборудования 19” 13Uх600х400'),
                    ('108', 'Шкаф для оборудования 19” 44Uх600х600'),
                    ('109', '19" шкаф для оборудования 20 Uх600 навесной'),
                    ('110', '19" шкаф для оборудования '),
                    ('111', 'Шкаф оборудования АССЦ Шкаф оборудования СКУ.МДЕ эксперимент'),
                    ('112', 'СДПС-Ц2МД СКУ.МД'),
                    ('113', 'СДПС-Ц2МД УУК-ЦМ'),
                    ('114', 'СДПС-Ц2МД УВЗ-ЦМ'),
                    ('115', 'Модули защиты ВМ-250 МЗ-250 ВМ-130 МР ВМ 320'),
                    ('116', 'Барьер –АБЧК-3М Ящик'),
                    ('117', 'Барьер –АБЧК-1М Шкаф'),
                    ('118', 'ШРУ-З'),
                    ('119', 'Шкаф оборудования'),
                    ('120', 'Шкаф оборудования');
                `);
